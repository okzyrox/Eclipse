...
proc setBorderColor*(element: UIElement, color: DrawColor) =
    ...
    of uitText:
        ...
        echo "Error: Cannot set border color on element of type: ", element.ui_type
...
proc setBorderSize*(element: UIElement, size: int) =
    ...
    of uitText:
        ...
        echo "Error: Cannot set border size on element of type: ", element.ui_type

proc newUIElement*(id: string, ui_type: UIType, position: Vec2 = Vec2(x: 0, y: 0), scale: Vec2 = Vec2(x: 1, y: 1), fore_color: DrawColor = DrawColor(r: 255, g: 255, b: 255, a: 255)): UIElement =
    UIElement(
        id: id,
        visible: true,
        position: position,
...
proc newTextElement*(id: string, text: string, position: Vec2 = Vec2(x: 0, y: 0), scale: Vec2 = Vec2(x: 1, y: 1), fore_color: DrawColor = DrawColor(r: 255, g: 255, b: 255, a: 255)): UIElement =
    result = newUIElement(
        id, 
        uitText, 
        position = position, 
...
proc newButtonElement*(id: string, button_text:string, position: Vec2 = Vec2(x: 0, y: 0), scale: Vec2 = Vec2(x: 1, y: 1), fore_color: DrawColor = DrawColor(r: 255, g: 255, b: 255, a: 255)): UIElement =
    result = newUIElement(
        id, 
        uitButton, 
        position = position, 
